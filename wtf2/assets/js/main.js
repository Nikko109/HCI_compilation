...
document.getElementById('loginForm').addEventListener('submit', function(e) {
  ...
  // Here, you can perform login validation or send login data to a backend server for authentication
  // For demonstration purpose, I'm just logging the values
...
document.getElementById('signupForm').addEventListener('submit', function(e) {
  ...
  // Here, you can perform signup validation or send signup data to a backend server for user creation
  // For demonstration purpose, I'm just logging the values
